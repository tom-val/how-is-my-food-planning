...
public record CreateRecipeRequest(string Name, string? Instructions, List<IngredientInput> Ingredients);
public record UpdateRecipeRequest(string Name, string? Instructions, List<IngredientInput> Ingredients);
